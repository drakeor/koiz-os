...
; This function isn't written by me.
; It comes from https://wiki.osdev.org/Detecting_Memory_(x86)#Getting_an_E820_Memory_Map
; It works alot better than my original method.
